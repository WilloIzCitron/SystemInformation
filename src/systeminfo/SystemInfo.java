...
public class SystemInfo extends Mod{
    ...
    public void init(){
        ...
        systemInfo.cont.add("Java: "+System.getProperty("java.vendor")+" "+System.getProperty("java.version")).row();
        systemInfo.cont.add("Java VM: "+System.getProperty("java.vm.vendor")+" "+System.getProperty("java.vm.version")).row();
    ...
    protected static String osIndent(){
        if(OS.isWindows){
            ...
            //vendor based
            if(System.getProperty("http.agent").equals("Infinix")){
